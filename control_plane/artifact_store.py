...
class ReplicatedArtifactStore:
    ...
    def _record_error(self, node_url: str, operation: str) -> None:
        if self.error_callback is not None:
            self.error_callback(node_url, operation)
    ...
    def put(self, checksum: str, content: bytes) -> None:
        ...
        for node_url in self.node_urls:
            try:
                ...
                self._record_error(node_url, "write")
        ...
        for node_url in self.node_urls:
            try:
                ...
                if hashlib.sha256(content).hexdigest() != checksum:
                    self._record_error(node_url, "read")
